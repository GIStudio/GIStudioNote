...
GeoAI、GIS 编程、AI4Science 的书籍、课程、视频与大学项目。
...
_Representative books and edited volumes covering GeoAI, spatial intelligence,
Earth observation and AI-driven disaster and environmental applications.
This list is **not exhaustive**, and community suggestions are welcome._
...
- **GeoAI with Python: A Practical Guide to Open-Source Geospatial AI** — A hands-on, practice-oriented guide to applying GeoAI using Python and open-source tools.  
  ...
  _(Table of contents: https://books.gishub.org/geoai/book-toc.pdf)_
...
_Representative educational resources supporting GeoAI, spatial intelligence, Earth observation, and AI-driven geospatial science.  
This section covers online courses, recorded lectures, and formal university programs.  
The list is **not exhaustive**, and community contributions are welcome._
