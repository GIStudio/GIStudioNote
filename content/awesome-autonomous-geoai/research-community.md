...
_Relevant conferences where the geospatial, GeoAI, and AI4Science communities (or parts thereof) meet._
...
_Representative research groups advancing GeoAI, GIScience, spatial intelligence,
...
_Key journals publishing high-impact research on GeoAI, remote sensing, GIScience, and AI4Science.
The following journals are ordered roughly by **overall prestige and influence** within the field.
This list is **not exhaustive**, and **community contributions and suggestions are very welcome**._
